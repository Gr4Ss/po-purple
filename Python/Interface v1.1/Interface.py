...
class Interface:
    ...
    def correct_speed(self,speed,speed_diff):
        ...
        # If the absolute value is less then the MINIMUM_SPEED its turned up
            ...
            sign = sign(speed)
            return [sign*MINIMUM_SPEED,sign*MINIMUM_SPEED+speed_diff]
    ...
    def rotate(self,degree):
        ...
        pid1 = PID.PID(10.,1./20.,1/10.,.2)
	pid2 = PID.PID(10.,1./20.,1/10.,.2)
    ...
    def ride_circ(self,radius):
        ...
        while angle < 2*math.pi:
            ...
            ## ispeed, ospeed = self.__correct_speed2(speed1,speed2)
            ## if DEBUG:
            ##  print 'Corrected speed: ', lspeed, rspeed
    ...
    def correct_speed2(self,inspeed,outspeed):
        ...
        if abs(outspeed) > abs(inspeed):
            ...
            routspeed = sing(outspeed) * max(MINIMUM_SPEED*1.1,abs(outspeed))
            rinspeed = sign(outspeed) * (inspeed/outspeed) * routspeed
